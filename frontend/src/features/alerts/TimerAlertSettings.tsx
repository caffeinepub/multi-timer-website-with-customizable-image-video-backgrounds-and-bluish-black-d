...
export function TimerAlertSettings() {
  ...
  return (
    <div className="space-y-6 rounded-lg border border-settings-crimson/30 bg-settings-pink-active p-5">
      {/* Header */}
      <div>
        <h3 className="text-base font-semibold text-settings-crimson">Timer Alerts</h3>
      ...
      <div className="flex items-center justify-between">
        <Label htmlFor="alerts-toggle" className="flex flex-col gap-1 cursor-pointer">
          <span className="text-settings-crimson font-medium">Enable completion alerts</span>
      ...
      <div className="space-y-3">
        <Label htmlFor="sound-select" className="text-base text-settings-crimson font-medium">
          Completion sound
        </Label>
