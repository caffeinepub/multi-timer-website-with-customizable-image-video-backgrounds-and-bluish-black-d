        ...
        <div className="w-full border-t border-settings-crimson/30 pt-3">
          ...
          <div className="grid gap-3 sm:grid-cols-3">
            <div className="space-y-1">
              <Label className="text-xs font-semibold text-settings-crimson">Interval A (sec)</Label>
              <EditableNumberInput
            ...
            <div className="space-y-1">
              <Label className="text-xs font-semibold text-settings-crimson">Interval B (sec)</Label>
              <EditableNumberInput
            ...
            <div className="space-y-1">
              <Label className="text-xs font-semibold text-settings-crimson">Rounds</Label>
              <EditableNumberInput
