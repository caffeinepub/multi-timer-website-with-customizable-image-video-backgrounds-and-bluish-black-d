    ...
    <div className="space-y-4 text-settings-crimson">
          ...
          <div className="flex items-center justify-between">
            <div className="flex flex-col gap-1">
              ...
              <p className="text-xs text-settings-crimson/70 flex items-center gap-1.5">
                {sourceType === "spotify" && (
                  <SiSpotify className="h-3.5 w-3.5 text-green-600" />
                )}
                {sourceType === "apple" && (
                  <SiApplemusic className="h-3.5 w-3.5 text-pink-600" />
                )}
                {sourceType === "spotify"
                  ? "Spotify"
                  : sourceType === "apple"
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          <Label htmlFor="music-url" className="text-settings-crimson">
            Music URL
          </Label>
        ...
        <div className="space-y-2">
          ...
          {isEmbedPlayer && (
            <p className="text-xs text-settings-crimson/60">
              Note: Volume control may not work for embedded players. Use the
              player's built-in volume control if needed.
            </p>
          )}
        </div>
      </div>
