 ...
 */
export function AnimatedDialRing({
  totalSeconds,
  size = 220,
}: AnimatedDialRingProps) {
    ...
    >
      ...
      {seconds > 0 && (
        <circle
          cx={
            center +
            outerRadius * Math.cos(secondsFraction * 2 * Math.PI - Math.PI / 2)
          }
          cy={
            center +
      ...
      {minutes > 0 && (
        <circle
          cx={
            center +
            innerRadius * Math.cos(minutesFraction * 2 * Math.PI - Math.PI / 2)
          }
          cy={
            center +
