...
export function BackgroundCustomizer() {
  ...
  const isVideoBackground =
    (mediaType === "video" || mediaType === "youtube") && isBackgroundActive;
    ...
    <div className="space-y-4 text-settings-crimson">
      ...
      {isBackgroundActive && (
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <Label
              htmlFor="background-brightness"
              className="flex items-center gap-2 text-settings-crimson"
            >
              <Sun className="h-4 w-4" />
              Background brightness
            </Label>
            <span className="text-sm text-settings-crimson/70">
              {brightness ?? 100}%
            </span>
          </div>
          ...
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-2 flex-1">
              ...
              <div className="flex flex-col gap-0.5">
                <Label
                  htmlFor="timer-overlay-toggle"
                  className="text-sm font-medium cursor-pointer text-settings-crimson"
                >
      ...
      <Tabs defaultValue="upload" className="w-full">
        ...
        <TabsContent value="upload" className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="file-upload" className="text-settings-crimson">
        ...
        <TabsContent value="url" className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="url-input" className="text-settings-crimson">
              Media URL
            </Label>
            <div className="flex gap-2">
              <Input
                ...
                onKeyDown={(e) =>
                  e.key === "Enter" && !isProbing && handleUrlSubmit()
                }
                disabled={isProbing}
        ...
        <TabsContent value="youtube" className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="youtube-input" className="text-settings-crimson">
              YouTube URL
            </Label>
            <div className="flex gap-2">
              <Input
