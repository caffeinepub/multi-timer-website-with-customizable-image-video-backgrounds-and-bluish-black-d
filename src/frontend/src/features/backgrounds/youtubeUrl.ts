  ...
  try {
    ...
    if (
      ...
      if (urlObj.pathname === "/watch") {
        ...
        return {
          error:
            "Invalid YouTube URL: missing or invalid video ID in watch URL.",
        };
      }
      ...
      if (urlObj.pathname.startsWith("/embed/")) {
        ...
        return {
          error:
            "Invalid YouTube URL: missing or invalid video ID in embed URL.",
        };
      }
      ...
      return {
        error:
          "Unsupported YouTube URL format. Please use a watch, embed, or youtu.be link.",
      };
    }
    ...
    if (urlObj.hostname === "youtu.be") {
      ...
      return {
        error: "Invalid YouTube URL: missing or invalid video ID in short URL.",
      };
    }

    return {
      error:
        "Not a recognized YouTube URL. Please use a youtube.com or youtu.be link.",
    };
  } catch {
