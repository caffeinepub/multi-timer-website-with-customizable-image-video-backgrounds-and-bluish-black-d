...
import { type NavigationTabId, getNavigationTabLabel } from "./navigationTabs";
...
export function ReorderableNavigationTabs({
  order,
  activeTab,
  onReorder,
  onTabChange,
}: ReorderableNavigationTabsProps) {
    ...
    const handlePointerMove = (moveEvent: PointerEvent) => {
      ...
      if (isDragging.current && tabsRef.current) {
        const tabs = Array.from(
          tabsRef.current.querySelectorAll("[data-tab-index]"),
        );
