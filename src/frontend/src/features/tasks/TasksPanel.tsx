import { CheckSquare, List, ListOrdered, Plus, Trash2, X } from "lucide-react";
import { type KeyboardEvent, useRef, useState } from "react";
import { type ListMode, useTasks } from "./useTasks";
...
export function TasksPanel({ onClose }: TasksPanelProps) {
  const { items, mode, addItem, toggleItem, deleteItem, setMode, clearAll } =
    useTasks();
